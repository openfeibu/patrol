<div class="main">
    <div class="layui-card fb-minNav">
        <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
            ...
            <a><cite>{{ trans("admin_user.name") }}</cite></a><span lay-separator="">/</span>
    </div>
    <div class="main_full">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('payment_user')}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ trans("admin_user.label.phone") }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="phone" value="{{ $payment_user->phone }}" lay-verify="title" autocomplete="off" placeholder="请输入{{ trans("admin_user.label.phone") }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
