                ...
                <form class="layui-form" action="{{guard_url('payment_user/'.$payment_user->id)}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone" value="{{ $payment_user->phone }}" lay-verify="title" autocomplete="off" placeholder="请输入{{ trans("admin_user.label.phone") }}" class="layui-input" disabled>
                        </div>
                    </div>
