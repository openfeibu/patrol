            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('provider_user')}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone" value="{{ $provider_user->phone }}" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans("provider_user.label.phone") }}" class="layui-input" >
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="password" name="password" placeholder="请输入{{ trans("provider_user.label.password") }}" autocomplete="off" class="layui-input" lay-verify="required">
                        </div>
