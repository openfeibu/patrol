...
class ProviderPermissionRepository extends BaseRepository implements ProviderPermissionRepositoryInterface
{


    public function boot()
    {
        $this->fieldSearchable = config('model.provider_roles.provider_permission.model.search');
    ...
    {
        return config('model.provider_roles.provider_permission.model.model');
    }
