...
use App\Traits\ProviderRoles\HasRoleAndPermission;
use App\Contracts\AdminUserPolicy;
use App\Traits\AdminUser\AdminUser as AdminUserProfile;

class ProviderUser extends AuthModel implements AdminUserPolicy
{
     ...
     * @var array
     */
    protected $config = 'model.user.provider_user.model';
