...
use App\Traits\PaymentRoles\HasRoleAndPermission;
use App\Contracts\AdminUserPolicy;
use App\Traits\AdminUser\AdminUser as AdminUserProfile;

class PaymentUser extends AuthModel implements AdminUserPolicy
{
     ...
     * @var array
     */
    protected $config = 'model.user.payment_user.model';
