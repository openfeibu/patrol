...
use App\Traits\PaymentRoles\PermissionHasRelations;

class PaymentPermission extends BaseModel
{
     ...
     * @var array
     */
     protected $config = 'model.payment_roles.payment_permission.model';
