...
class RoleResourceController extends BaseController
{
     ...
     *
     * @param type PaymentRoleRepositoryInterface $role
     * @param type PaymentPermissionRepositoryInterface $permission
     *
     */
    public function __construct(
        PaymentRoleRepositoryInterface       $role,
        PaymentPermissionRepositoryInterface $permission
    ) {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->orderBy('id','asc')
                ->setPresenter(\App\Repositories\Presenter\PaymentRoleListPresenter::class)
                ->getDataTable($limit);
     ...
     *
     * @param Request $request
     * @param PaymentRole   $role
     *
     * @return Response
     */
    public function show(Request $request, PaymentRole $role)
    {
        if ($role->exists) {
            $view = 'role.show';
        } else {
     ...
     * @return Response
     */
    public function edit(Request $request, PaymentRole $role)
    {
     ...
     * @return Response
     */
    public function update(Request $request, PaymentRole $role)
    {
        try {
            $attributes = $request->all();
     ...
     * @return Response
     */
    public function destroy(Request $request, PaymentRole $role)
    {
        try {
            $role->forceDelete();
