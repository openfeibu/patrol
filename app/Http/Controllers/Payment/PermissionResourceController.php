...
use App\Http\Requests\PaymentPermissionRequest;
...
class PermissionResourceController extends BaseController
{
     ...
     * @return null
     */
    public function __construct(PaymentPermissionRepositoryInterface $permission)
    {
        parent::__construct();
    ...
    /**
     * @param Request $request
     * @param PaymentPermission $permission
     * @return mixed
     */
    public function show(Request $request, PaymentPermission $permission)
    {
     ...
     * @return Response
     */
    public function edit(Request $request, PaymentPermission $permission)
    {
     ...
     * @return Response
     */
    public function update(Request $request, PaymentPermission $permission)
    {
        try {
            $attributes = $request->all();
     ...
     * @return mixed
     */
    public function destroy(Request $request, PaymentPermission $permission)
    {
        try {
