...
class PermissionResourceController extends BaseController
{
     ...
     *
     */
    public function __construct(ProviderPermissionRepositoryInterface $permission)
    {
        parent::__construct();
    ...
    /**
     * @param Request $request
     * @param ProviderPermission $permission
     * @return mixed
     */
    public function show(Request $request, ProviderPermission $permission)
    {
     ...
     * @return Response
     */
    public function edit(Request $request, ProviderPermission $permission)
    {
     ...
     * @return Response
     */
    public function update(Request $request, ProviderPermission $permission)
    {
        try {
            $attributes = $request->all();
     ...
     * @return mixed
     */
    public function destroy(Request $request, ProviderPermission $permission)
    {
        try {
